...
EXT_NET_CIDR=${EXT_NET_CIDR:-'10.10.101.0/24'}
EXT_NET_RANGE=${EXT_NET_RANGE:-'start=10.10.101.150,end=10.10.101.199'}
EXT_NET_GATEWAY=${EXT_NET_GATEWAY:-'10.10.101.1'}
...
openstack subnet create --subnet-range 192.168.1.0/24 --network demo-net \
    --gateway 192.168.1.1 --dns-nameserver 8.8.8.8 demo-subnet
...
openstack security group rule create --ingress --ethertype IPv4 \
	    --protocol tcp --dst-port 80 ${ADMIN_SEC_GROUP}
